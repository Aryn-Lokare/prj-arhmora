...
import { Globe, Check, AlertCircle, Activity, Info, AlertTriangle, Sparkles, ExternalLink, RefreshCw } from "lucide-react";
...
function ResultsContent() {
    ...
    const initiateScan = async (targetUrl) => {
        ...
        try {
            ...
            handleError(error.response?.data?.message || "Infrastructure reachability failed.");
        }
    };
                            ...
                            <div key={idx} className={cn(
                                ...
                                {msg.type === "user" ? (
                                    ...
                                    <div className="w-full bg-red-50 border border-red-100 p-8 rounded-[32px] flex flex-col items-center gap-6 shadow-sm text-center">
                                        ...
                                        <div>
                                            <p className="text-red-800 font-bold uppercase tracking-widest text-sm mb-2">Scan Encountered an Error</p>
                                            <p className="text-red-700 font-medium max-w-lg mx-auto">{msg.content}</p>
                                        </div>
                                        <Button
